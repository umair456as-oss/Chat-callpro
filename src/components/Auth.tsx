...
export default function Auth() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#F0F2F5] p-4 font-sans">
      <div className="bg-white p-8 rounded-2xl shadow-2xl flex flex-col items-center max-w-md w-full border border-gray-100">
        <div className="w-20 h-20 bg-[#700122] rounded-full mb-6 flex items-center justify-center shadow-lg ring-4 ring-[#700122]/10 transition-transform hover:scale-110">
        ...
        <h1 className="text-2xl font-bold text-[#700122] mb-1">Alpha Chat</h1>
        <p className="text-gray-500 text-center mb-8 text-sm">Connect, Chat, and Earn Rewards Daily.</p>
        ...
        <form onSubmit={handleEmailAuth} className="w-full space-y-4">
          {isRegistering && (
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-gray-50 border border-gray-200 focus:border-[#700122] rounded-xl py-3 pl-10 pr-4 text-gray-900 text-sm outline-none transition-all"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#700122] hover:bg-[#500118] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-3 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 group"
          >
            {loading ? (
        ...
        <button
          ...
          className="mt-6 text-[#700122] hover:underline text-sm font-medium"
        >
          {isRegistering ? 'Already have an account? Sign In' : "Don't have an account? Register"}
        </button>

        <p className="mt-8 text-[10px] text-gray-500 text-center leading-relaxed">
          By continuing, you agree to Alpha Chat's <br />
          <span className="text-[#700122] cursor-pointer">Terms of Service</span> and <span className="text-[#700122] cursor-pointer">Privacy Policy</span>.
        </p>
      </div>
    </div>
  );
