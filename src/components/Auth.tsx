...
export default function Auth() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#F0F2F5] p-4 font-sans relative overflow-hidden">
      {/* Background Pattern */}
      <div 
      ...
      <div className="bg-white p-8 rounded-2xl shadow-2xl flex flex-col items-center max-w-md w-full border border-gray-100 z-10">
        <div className="w-20 h-20 bg-[#25D366] rounded-full mb-6 flex items-center justify-center shadow-lg ring-4 ring-[#25D366]/10 transition-transform hover:scale-110">
        ...
        <h1 className="text-3xl font-bold text-[#111B21] mb-2">WhatsApp</h1>
        <p className="text-[#667781] text-center mb-8 text-sm font-medium">Simple. Reliable. Private.</p>
        ...
        <form onSubmit={handleEmailAuth} className="w-full space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#25D366] hover:bg-[#20bd5c] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-3 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 group"
          >
            {loading ? (
